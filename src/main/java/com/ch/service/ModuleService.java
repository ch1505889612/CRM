...
import com.ch.mapper.ModuleMapper;
...
public class ModuleService extends BaseService<Module,Integer> {
    ...
    public void updateModule(Module module){
        ...
        AssertUtil.isTrue(StringUtils.isBlank(module.getModuleName()),"请指定菜单名 称!");
        Integer grade =module.getGrade();
        AssertUtil.isTrue(null== grade|| !(grade==0||grade==1||grade==2),"菜单层级不合 法!");
    ...
    public List<Map<String, Object>> queryAllModulesByGrade(Integer grade) {
       AssertUtil.isTrue(grade!=0,"不能为空");
